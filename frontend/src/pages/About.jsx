    ...
    <div>
      ...
      <div className="flex flex-col md:flex-row mb-20">
        {[
          ...
          <div
            key={index}
            className="border px-10 md:px-16 py-8 sm:py-16 flex flex-col gap-5 text-[15px] hover:text-white hover:bg-blue-500 transition-all duration-300 text-gray-600 cursor-pointer"
          >
            <b>{item.title}</b>
            <p>{item.text}</p>
          </div>
